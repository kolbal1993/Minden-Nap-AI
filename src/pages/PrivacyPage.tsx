      ...
      <main className="pt-32 pb-20 px-6">
        <div className="max-w-4xl mx-auto">
          ...
          <div className="mb-16 text-center">
            ...
            >
              Adatvédelmi <span className="text-blue-600">Tájékoztató</span>
            </motion.h1>
            <motion.p 
              initial={{ opacity: 0, y: 20 }}
              animate={{ opacity: 1, y: 0 }}
          ...
          <div className="space-y-12 text-gray-700 dark:text-gray-100 leading-relaxed">
            <section className="bg-white dark:bg-[var(--bg-card)] border border-black/5 dark:border-white/5 rounded-2xl p-8 md:p-12 shadow-2xl">
              <h2 className="text-2xl font-bold text-gray-900 dark:text-white mb-6 flex items-center gap-3">
                <Info className="text-blue-600 w-6 h-6" /> 1. Bevezetés
              </h2>
              <p className="mb-4">
            ...
            <section className="bg-white dark:bg-[var(--bg-card)] border border-black/5 dark:border-white/5 rounded-2xl p-8 md:p-12 shadow-2xl">
              <h2 className="text-2xl font-bold text-gray-900 dark:text-white mb-6 flex items-center gap-3">
                <Database className="text-blue-600 w-6 h-6" /> 2. Gyűjtött adatok köre
              </h2>
              <div className="grid md:grid-cols-2 gap-6">
                <div className="p-6 rounded-2xl bg-white/5 border border-white/5">
                  <h3 className="font-bold text-gray-900 dark:text-white mb-2 flex items-center gap-2">
                    <UserCheck className="w-4 h-4 text-blue-600" /> Regisztrációs adatok
                  </h3>
                  <p className="text-sm text-gray-700 dark:text-gray-100">Név, e-mail cím, jelszó (titkosítva), cégnév (opcionális).</p>
                </div>
                <div className="p-6 rounded-2xl bg-white/5 border border-white/5">
                  <h3 className="font-bold text-gray-900 dark:text-white mb-2 flex items-center gap-2">
                    <Eye className="w-4 h-4 text-blue-600" /> Használati adatok
                  </h3>
            ...
            <section className="bg-white dark:bg-[var(--bg-card)] border border-black/5 dark:border-white/5 rounded-2xl p-8 md:p-12 shadow-2xl">
              <h2 className="text-2xl font-bold text-gray-900 dark:text-white mb-6 flex items-center gap-3">
                <Lock className="text-blue-600 w-6 h-6" /> 3. Az adatkezelés célja
              </h2>
            ...
            <section className="bg-white dark:bg-[var(--bg-card)] border border-black/5 dark:border-white/5 rounded-2xl p-8 md:p-12 shadow-2xl">
              <h2 className="text-2xl font-bold text-white mb-6 flex items-center gap-3">
                <Shield className="text-blue-600 w-6 h-6" /> 4. Az Ön jogai
              </h2>
            ...
            <div className="p-8 rounded-xl bg-blue-600/5 border border-blue-500/10 text-center">
              <p className="text-gray-700 dark:text-gray-100 text-sm italic">
                Adatvédelmi kérdésekben írjon nekünk az <a href="mailto:privacy@mindennapai.hu" className="text-blue-600 font-bold hover:underline">privacy@mindennapai.hu</a> címen.
              </p>
            </div>
          </div>
        </div>
