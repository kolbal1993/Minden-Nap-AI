      ...
      <main className="pt-32 pb-20 px-6">
        <div className="max-w-4xl mx-auto">
          ...
          <div className="mb-16 text-center">
            ...
            >
              Általános <span className="text-blue-600">Szerződési Feltételek</span>
            </motion.h1>
            <motion.p 
              initial={{ opacity: 0, y: 20 }}
              animate={{ opacity: 1, y: 0 }}
          ...
          <div className="space-y-12 text-gray-700 dark:text-gray-100 leading-relaxed">
            <section className="bg-white dark:bg-[var(--bg-card)] border border-black/5 dark:border-white/5 rounded-2xl p-8 md:p-12 shadow-2xl">
              <h2 className="text-2xl font-bold text-gray-900 dark:text-white mb-6 flex items-center gap-3">
                <FileText className="text-blue-600 w-6 h-6" /> 1. Általános rendelkezések
              </h2>
              <p className="mb-4">
            ...
            <section className="bg-white dark:bg-[var(--bg-card)] border border-black/5 dark:border-white/5 rounded-2xl p-8 md:p-12 shadow-2xl">
              <h2 className="text-2xl font-bold text-gray-900 dark:text-white mb-6 flex items-center gap-3">
                <ShieldCheck className="text-blue-600 w-6 h-6" /> 2. Szolgáltatások köre
              </h2>
              <ul className="space-y-4">
                <li className="flex gap-3">
                  <CheckCircle2 className="text-blue-600 w-5 h-5 shrink-0 mt-1" />
            ...
            <section className="bg-white dark:bg-[var(--bg-card)] border border-black/5 dark:border-white/5 rounded-2xl p-8 md:p-12 shadow-2xl">
              <h2 className="text-2xl font-bold text-gray-900 dark:text-white mb-6 flex items-center gap-3">
                <Lock className="text-blue-600 w-6 h-6" /> 3. Regisztráció és adatvédelem
              </h2>
              <p className="mb-4">
            ...
            <section className="bg-white dark:bg-[var(--bg-card)] border border-black/5 dark:border-white/5 rounded-2xl p-8 md:p-12 shadow-2xl">
              <h2 className="text-2xl font-bold text-gray-900 dark:text-white mb-6 flex items-center gap-3">
                <AlertCircle className="text-blue-600 w-6 h-6" /> 4. Felelősségkorlátozás
              </h2>
              <p className="mb-4">
            ...
            <div className="p-8 rounded-xl bg-blue-600/5 border border-blue-500/10 text-center">
              <p className="text-gray-700 dark:text-gray-100 text-sm italic">
                Kérdés esetén forduljon hozzánk bizalommal az <a href="mailto:info@mindennapai.hu" className="text-blue-600 font-bold hover:underline">info@mindennapai.hu</a> e-mail címen.
              </p>
            </div>
          </div>
        </div>
